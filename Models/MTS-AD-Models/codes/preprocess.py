...
datasets = ['ours', 'synthetic', 'SMD', 'SWaT', 'SMAP', 'MSL', 'WADI', 'MSDS', 'UCR', 'MBA', 'NAB']
...
def load_data(dataset):
	...
	if dataset == 'synthetic':
		...
		train = pd.read_csv('data/ours/train.csv', header=None)
		test = pd.read_csv('data/ours/test.csv', header=None)
		labels = pd.read_csv('data/ours/labels.csv', header=None)
